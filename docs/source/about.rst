...
<https://github.com/paulsuh/pytest-scenario-files/issues>`__ including a detailed
description and (if possible) an example of the problem.
...
This ``pytest`` plugin was developed using a skeleton generated by `cookiecutter
<https://pypi.org/project/cookiecutter/>`_ along with the `cookiecutter-pytest-plugin
<https://github.com/pytest-dev/cookiecutter-pytest-plugin>`_ template, then extensively
